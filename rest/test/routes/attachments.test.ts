...
describe("GET /mailboxes/:mailbox/messages/:uid/attachments/:index", () => {
  ...
  it("returns 401 when credential headers are missing", async () => {
    ...
    const response = await app.inject({
      method: "GET",
      url: "/mailboxes/INBOX/messages/42/attachments/0",
    });
  ...
  it("returns 400 for a non-numeric UID", async () => {
    ...
    const response = await app.inject({
      method: "GET",
      url: "/mailboxes/INBOX/messages/abc/attachments/0",
  ...
  it("returns 400 for UID of zero", async () => {
    ...
    const response = await app.inject({
      method: "GET",
      url: "/mailboxes/INBOX/messages/0/attachments/0",
      headers: CRED_HEADERS,
    });
    expect(response.statusCode).toBe(400);
    await app.close();
  ...
  it("returns 400 for a negative attachment index", async () => {
    ...
    const response = await app.inject({
      method: "GET",
      url: "/mailboxes/INBOX/messages/42/attachments/-1",
      headers: CRED_HEADERS,
    });
    expect(response.statusCode).toBe(400);
    await app.close();
  ...
  it("returns 400 for a non-numeric attachment index", async () => {
    ...
    const response = await app.inject({
      method: "GET",
      url: "/mailboxes/INBOX/messages/42/attachments/abc",
      headers: CRED_HEADERS,
    });
    expect(response.statusCode).toBe(400);
    await app.close();
  ...
  it("returns 404 when message is not found", async () => {
    ...
    const response = await app.inject({
      method: "GET",
      url: "/mailboxes/INBOX/messages/99/attachments/0",
      headers: CRED_HEADERS,
    });
  ...
  it("returns 404 when attachment index is out of range", async () => {
    ...
    const response = await app.inject({
      method: "GET",
      url: "/mailboxes/INBOX/messages/42/attachments/5",
      headers: CRED_HEADERS,
    });
    expect(response.statusCode).toBe(404);
